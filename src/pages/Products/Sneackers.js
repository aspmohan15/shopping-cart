...
const Sneakers = () => {
  return (
    <>
      <div className="hidden md:flex items-center justify-center space-x-10 font-semibold text-lime-600 mt-5">
      ...
      <div className=" md:hidden flex items-center justify-center space-x-10 font-semibold text-lime-600 mt-5">
